...
const PendingReview = lazy(() => import("@/pages/guide/PendingReview"));
    ...
    <PageTransition>
      <Suspense fallback={<PageLoader />}>
        <Routes location={location}>
          ...
          {/* Guide Routes */}
          <Route path="/guide/kyc" element={<ProtectedRoute><KYC /></ProtectedRoute>} />
          <Route path="/guide/pending" element={<ProtectedRoute><PendingReview /></ProtectedRoute>} />
